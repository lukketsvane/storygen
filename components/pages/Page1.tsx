  ...
  return (
    <Box>
      ...
      <Text>
        ...
        begynner å bruke tjenesten, og har ingen bindingstid. Brukeren kan endre avtalen, ved å klikke på “Administrer abonnement" de endre eller avslutte abonnementet sitt.
      </Text>
